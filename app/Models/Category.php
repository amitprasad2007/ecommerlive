...
{
    protected $fillable=['title','slug','summary','photo','status','is_parent','parent_id','sub_cat_id','added_by','icon_path'];

    public function parent_info(){
        return $this->hasOne('App\Models\Category','id','parent_id');
    }
    public function sub_parent_info(){
    ...
    public static function getSubChildByParentID($id){
        return Category::where('sub_cat_id',$id)->orderBy('id','ASC')->pluck('title','id');
    }
