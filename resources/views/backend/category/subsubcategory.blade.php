            ...
            @foreach($categories as $category)
              ...
              @endphp
                <tr>
                    ...
                    <td>
                        {{$category->sub_parent_info->title ?? ''}}
                    </td>
                    <td>
                        @if($category->photo)
                    ...
                    <td>
                        <a href="{{route('admin.category.subsubedit',$category->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
